...
class UsersTestUrls(SimpleTestCase):
    def test_register_url(self):
        ...
        self.assertEquals(resolve(url).func.__name__, RegisterView.as_view().__name__)
    ...
    def test_activate_email_url(self):
        ...
        self.assertEquals(resolve(url).func.__name__, ActivateEmail.as_view().__name__)

    def test_reset_password_url(self):
        url = reverse('password-reset')
        self.assertEquals(resolve(url).func.__name__, ResetPasswordView.as_view().__name__)
    ...
    def test_password_reset_confirm_url(self):
        ...
        self.assertEquals(resolve(url).func.__name__, auth_views.PasswordResetConfirmView.as_view().__name__)

    def test_password_reset_complete_url(self):
        url = reverse('password-reset-complete')
        self.assertEquals(resolve(url).func.__name__, auth_views.PasswordResetCompleteView.as_view().__name__)
